            ...
            return Padding(
              ...
              child: ListView.builder(
                controller: _scrollController,
                  ...
                  itemBuilder: (ctx, idx) {
                    ChatMessage msg = msgs[idx];
                    ChatMessage? prevMsg = idx > 0 ? msgs[idx-1] : null;

                    return Message(
                        username: msg.fromUsername,
                        isFirst: idx == 0 || (idx > 0 && prevMsg!.from.compareTo(msgs[idx].from) != 0),
                        isMy: msg.from.compareTo(FirebaseAuth.instance.currentUser!.uid) == 0 ,
                        userAvatarUrl: msg.imgUrl,
                        msg: msg.msg
                      );
                    //return ListTile(
                    //  title: Text(msgs[idx].data()['text'] as String),
                    //);
                  }),
            );
          }),
